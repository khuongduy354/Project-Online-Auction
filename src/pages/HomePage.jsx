        ...
        <div className="container mx-auto px-4 py-8 space-y-12">
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 md:col-span-1">
                ...
                {CATEGORIES.map(cat => (
                    ...
                    <span className="text-xs bg-gray-100 text-gray-500 px-2 py-0.5 rounded-full">124</span>
                    </li>
                ))}
                </ul>
            </div>
            
            <div className="md:col-span-3 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl shadow-lg text-white p-8 flex flex-col justify-center relative overflow-hidden">
            ...
            {loading ? (
                ...
                {MOCK_PRODUCTS.sort((a, b) => a.timeLeft - b.timeLeft).map(product => (
            ...
            />
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {MOCK_PRODUCTS.sort((a, b) => b.bidCount - a.bidCount).map(product => (
                    <ProductCard key={product.id} product={product} />
                ))}
                </div>
            </section>
